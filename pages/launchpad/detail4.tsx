...
const LaunchpadDetails = () => {
  ...
  const mint = async (type: number) => {
    ...
    if (
      new Date().getTime() > 1687752000 * 1000 + 12 * 60 * 60 * 1000 &&
      type == 1
    ) {
    ...
    if (
      new Date().getTime() > 1687870800 * 1000 + 12 * 60 * 60 * 1000 &&
      type == 2
    ) {
      toast.warning("The Whitelist sale round has end", toastConfig);
      return;
          ...
          <div className={styles.card + " " + styles.project}>
            ...
            <div className={styles.info}>
              ...
              <p className={styles.intro}>
                The Edohigan Network provides fast and easy-to-use tools that
                enable decentralized data validation, immutability and
                retrieval, empowering developers and data engineers to access
                reliable data they can use to build the future of Web3 with
                confidence.
              </p>
          ...
          <div className={styles.data}>
            <div className={styles.card + " " + styles.protocol}>
              <div className={styles.item}>
                ...
                <p>
                  Accessing decentralized and entirely accurate data is becoming
                  progressively difficult for the general public, subsequently
                ...
                <p>
                  ...
                  ecological development, marketing incentives, partner
                  establishment, community building, etc. Cooperate with
                ...
                <p>
                  ...
                  each release will trigger a community vote.
                </p>
              </div>
            </div>
