...
const Launchpad = () => {
  ...
  const ListItem = item => {
    if (typeof item.id === 'number') {
          ...
          <div className={styles.main}>
            <Link href={item.details} passHref>
              <div className={styles.banner}>
                <Image src={item.banner} alt="Remote Image" layout="fill" objectFit="cover" />
                {item.hot ? (
            ...
            <div className={styles.avatar}>
              <Image src={item.avatar} alt="avatar" width={80} height={80} objectFit="cover" />
            </div>
            ...
            <div className={styles.contact}>
              ...
              {item.discord && (
                <Link href={item.discord} passHref>
                  <a className={styles.item}>
                    <Image src={discord} alt="discord" width={24.24} height={20}></Image>
                  </a>
                </Link>
              )}
              {item.telegram && (
              ...
              {item.medium && (
                <Link href={item.medium} passHref>
                  <a className={styles.item}>
                    <Image src={medium} alt="medium" width={25.8} height={20}></Image>
                  </a>
                </Link>
              )}
            </div>
      ...
      return <div className={styles.listItem} key={item.id} style={{ backgroundColor: 'transparent' }}></div>;
    }
  };
        ...
        <div className={styles.inner}>
          <div className={styles.info}>
            <div className={styles.text}>
              ...
              <p>
                Biso helps everyone to create their own tokens and token sales in few seconds. Tokens created on Biso
          ...
          <div className={styles.list}>{projectList.map(item => ListItem(item))}</div>
        </div>
      </div>
    </HeaderFooter>
  );
